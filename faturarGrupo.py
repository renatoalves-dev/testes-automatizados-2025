...
time.sleep(80)
faturarGrupo = driver.find_element(By.XPATH, '/html/body/div[1]/div[2]/div/div[2]/form/div[1]/div[2]/div[2]/div/div[2]/table/tbody/tr[6]/td[9]/a').click()
time.sleep(10)

dataSelecionar = driver.find_element(By.ID, "periodoEmissao")
options.set_preference('javascript.enabled', False)

dataSelecionar.click()
time.sleep(40)
dataSelecionar.send_keys("13/01/2025")
time.sleep(10)
